...
;   2019-09013 modify THM_MAP_SET to configure detail setting (add keyword 'grid' to plot lines of gogeographic lat and lon)
; VERSION:
...
pro thm_map_set_2,scale=scale,$                         ;scale for map set
  ...
  rotation=rotation,$
  no_color=no_color,$
  grid=grid                           ; plot lines of gogeographic latitude and longitude
  ...
  map_set,name=name,lat1,lon1,rot,scale=scale1,position=pa1,noerase=noerase, /grid
